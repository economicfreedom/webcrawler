...
@Mapper
public interface ITWordCloud  extends DBInterface<CloudVO> {
    @Override
    @Insert("INSERT INTO i_cloud (create_at, content1, content2, content3, content4, content5, content6, content7, content8, content9, content10) " +
    ...
    @Override
    @Select("select max(id) from i_cloud ")
    Integer getMaxId();
}
